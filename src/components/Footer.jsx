...
import { footerLinks, socialLinks } from '../database/Data';
            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between md:gap-24 gap-16 mb-16">
                    ...
                    <div className="md:w-1/3">
                        ...
                        <p className="text-gray-400 md:w-2/3">
                            The first-ever website experience platform that lets
                            you create, manage and optimize your digital
                            presence.
                        </p>
                    </div>
                ...
                <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="text-gray-400 text-sm">
                        © {new Date().getFullYear()} CodeTutor UI. All rights
                        reserved.
                    </div>
                </div>
            </div>
